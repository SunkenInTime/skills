...
- Light is warm off-white paper (`#f4f1e9`), decidedly not white — if a screenshot of light mode could pass for `#fff`, it has drifted. The accent darkens to `#3f52c9` and the verdict colors deepen — the dark values fail contrast on paper.
