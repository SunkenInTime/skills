...
4. **Artifacts.** Capture artifacts if necessary. Showcase visual or interaction changes with comparable before/after images or video. For uploads, read [Attachments](references/uploading-artifacts.md).
