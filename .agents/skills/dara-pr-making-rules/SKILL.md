...
4. Open one ready-for-review PR following the repo's PR guidelines and template. Include the reproduction steps, before-and-after screenshots, and verification results. State any verification blockers explicitly.
